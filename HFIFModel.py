...
#Build 4:
    def calTensorData(self,isTrain=True,strSDate='0',strEDate='99990101'):
...
if __name__=='__main__':
    ...
    #HFIF_Model.calTensorData(strEDate='20190101')
    #HFIF_Model.calTensorData(isTrain=False,strSDate='20190101')
